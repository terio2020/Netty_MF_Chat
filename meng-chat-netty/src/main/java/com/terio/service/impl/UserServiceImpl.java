package com.terio.service.impl;

import com.terio.enums.MsgActionEnum;
import com.terio.enums.MsgSignFlagEnum;
import com.terio.enums.SearchFriendsStatusEnum;
import com.terio.mapper.*;
import com.terio.netty.DataContent;
import com.terio.netty.UserChannelRel;
import com.terio.org.n3r.idworker.Sid;
//import com.terio.pojo.ChatMsg;
import com.terio.pojo.ChatMsg;
import com.terio.pojo.FriendsRequest;
import com.terio.pojo.MyFriends;
...
import com.terio.utils.JsonUtils;
import com.terio.utils.QRCodeUtils;
...
/**
 * Created by Terto_MY on 2021/6/23 12:12
 */
@Service
public class UserServiceImpl implements UserService {
    ...
    public String saveMsg(ChatMsg chatMsg) {
        com.terio.pojo.ChatMsg msgDB = new com.terio.pojo.ChatMsg();
    ...
    @Transactional(propagation = Propagation.SUPPORTS)
    @Override
    public List<com.terio.pojo.ChatMsg> getUnReadMsgList(String acceptUserId) {

        Example chatExample = new Example(com.terio.pojo.ChatMsg.class);
        Example.Criteria chatCriteria = chatExample.createCriteria();
        chatCriteria.andEqualTo("signFlag", 0);
        chatCriteria.andEqualTo("acceptUserId", acceptUserId);

        List<com.terio.pojo.ChatMsg> result = chatMsgMapper.selectByExample(chatExample);

        return result;
    }

    @Override
    public String saveMsg(com.terio.netty.ChatMsg chatMsg) {
        com.terio.pojo.ChatMsg msgDB = new com.terio.pojo.ChatMsg();
        String msgId = sid.nextShort();
        msgDB.setId(msgId);
        msgDB.setAcceptUserId(chatMsg.getReceiverId());
